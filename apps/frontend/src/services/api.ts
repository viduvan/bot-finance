...
export interface SystemConfig { app_name: string; version: string; trading: { mode: string; symbols: string[] }; risk: Record<string, number>; mfa_enabled: boolean; }
...
export const analysisApi = {
  ...
  history: (symbol: string, limit = 10) => api.get(`/api/v1/analysis/${symbol}/history?limit=${limit}`),
